...
const DisplayProduct = ({ product, setamodalstatus,setreportamodal }) => {
    const {description , photoUrl, itemName, location, nagotiationFlag,originalPrice, resalePrice,usedtime, userName, userVerification, userPhoto,brand,createdOn} = product;
